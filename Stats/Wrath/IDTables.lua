...
AddonTable.dodgeChance, AddonTable.parryChance, AddonTable.blockChance, AddonTable.avoid = 0, 0, 0, 0
AddonTable.hasteEnchants, AddonTable.buffCount, AddonTable.heroicPresence, AddonTable.zoneBuff = 0, 0, 0, 0, 0
...
AddonTable.parryChance, AddonTable.dodgeChance, AddonTable.averageiLvl = 0, 0, 0
AddonTable.playerLevel = UnitLevel("player")
AddonTable.dwarfRacial, AddonTable.quickness, AddonTable.weaponTag, AddonTable.totalDefense, AddonTable.runeInvicibility = false, 0, 2, 0, 0
--mage
...
-- warlock
AddonTable.shadowMastery, AddonTable.Suppression, AddonTable.curseOfWeak, AddonTable.shadowDmg, AddonTable.curseElements = 0, 0, 0, 0, 0
AddonTable.masterImp, AddonTable.masterFel, AddonTable.masterSucc, AddonTable.dsSuc, AddonTable.dsImp, AddonTable.felEnergy = 0, 0, 0, 0, 0, 0
AddonTable.impShadowbolt, AddonTable.fireStone, AddonTable.MoltenSkin = 0, 0, 0
...
AddonTable.balancePower, AddonTable.giftNature, AddonTable.survFittest, AddonTable.starlight, AddonTable.earthMother, AddonTable.predStrikes = 0, 0, 0, 0, 0, 0
AddonTable.faerieFire, AddonTable.insectSwarm, AddonTable.treeofLife, AddonTable.earthMoon, AddonTable.FaerieImproved, AddonTable.faerieFireImp = 0, 0, 0, 0, 0, 0
-- hunter
AddonTable.huntersMark, AddonTable.serpentSwift, AddonTable.scorpidSting, AddonTable.aspectViper = 0, 0, 0, 0

--------------------------------------
--		Racial Effects check		--
--------------------------------------
