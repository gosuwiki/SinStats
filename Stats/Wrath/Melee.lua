...
function AddonTable.FunctionList.DMG(HUD, data, options, ...)
	...
	maxDamage = hiDmg + (hiDmg * AddonTable.crusadeTalent) + (hiDmg * AddonTable.desolation) + (hiDmg * AddonTable.frostFever) + (hiDmg * AddonTable.rageRivendare) + AddonTable.hemoDmg + (hiDmg * AddonTable.bloodFrenzy) + (hiDmg * AddonTable.savageCombat)
	lowDamage = lowDmg + (lowDmg * AddonTable.crusadeTalent) + (lowDmg * AddonTable.desolation) + (lowDmg * AddonTable.frostFever) + (lowDmg * AddonTable.rageRivendare) + AddonTable.hemoDmg + (lowDmg * AddonTable.bloodFrenzy) + (lowDmg * AddonTable.savageCombat)
	maxDamageOH = offhiDmg + (offhiDmg * AddonTable.crusadeTalent) + (offhiDmg * AddonTable.desolation) + (offhiDmg * AddonTable.frostFever) + (offhiDmg * AddonTable.rageRivendare) + AddonTable.hemoDmg + (offhiDmg * AddonTable.bloodFrenzy) + (offhiDmg * AddonTable.savageCombat)
	lowDamageOH = offlowDmg + (offlowDmg * AddonTable.crusadeTalent) + (offlowDmg * AddonTable.desolation) + (offlowDmg * AddonTable.frostFever) + (offlowDmg * AddonTable.rageRivendare) + AddonTable.hemoDmg + (offlowDmg * AddonTable.bloodFrenzy) + (offlowDmg * AddonTable.savageCombat)
...
function AddonTable.FunctionList.weaponSpeed(HUD, data, options, ...)
	...
	if AddonTable.Band(EB, MainHand) then returnText = ("%.1f"):format(mainSpeed) end
	if  AddonTable.Band(EB, OffHand) then returnText = ("%.1f"):format(offHandAuto) end
	if AddonTable.Band(EB, Auto) then returnText = ("%.1f"):format(mainSpeed) .. offHandSpeed end
