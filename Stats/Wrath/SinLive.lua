...
AddonTable.faerieFire, AddonTable.curseOfWeak, AddonTable.shatterArmor, AddonTable.frostFever, AddonTable.scorpidSting, AddonTable.insectSwarm = 0, 0, 0, 0, 0, 0
...
AddonTable.heartCrusader, AddonTable.savageCombat, AddonTable.impShadowbolt, AddonTable.faerieFireImp, AddonTable.masterPoisoner, AddonTable.moltenFury = 0, 0, 0, 0, 0, 0
	...
	local _, _, dcount, _, _, _, _, _, _, debuffId = UnitDebuff("target", i)
		...
		if AddonTable.ArmorDebuffs.FaerieFire[debuffId] then AddonTable.faerieFire = AddonTable.ArmorDebuffs.FaerieFire[debuffId][1]; AddonTable.faerieFireImp = AddonTable.FaerieImproved end
